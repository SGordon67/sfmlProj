...
BasicObject.o: BasicObject.cpp BasicObject.h enums.h globals.h
	$(CXX) $(CXXFLAGS) -c BasicObject.cpp

VisualObject.o: VisualObject.cpp VisualObject.h enums.h globals.h
	$(CXX) $(CXXFLAGS) -c VisualObject.cpp

StaticPhysicalObject.o: StaticPhysicalObject.cpp StaticPhysicalObject.h enums.h globals.h
	$(CXX) $(CXXFLAGS) -c StaticPhysicalObject.cpp

PhyscialObject.o: PhysicalObject.cpp PhysicalObject.h enums.h globals.h
	$(CXX) $(CXXFLAGS) -c PhysicalObject.cpp

Player.o: Player.cpp Player.h enums.h globals.h
	$(CXX) $(CXXFLAGS) -c Player.cpp

globals.o: globals.cpp enums.h globals.h
